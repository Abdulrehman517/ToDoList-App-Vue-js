<template>
 ...
 <h1>{{title}}</h1>
    <childVue v-on:changeTitle="updateTitleText($event)"></childVue>
  ...
  <div id="app">
    ...
    <ul  aria-labelledby="list-summary" class="stack-large">
      <li v-for="item in ToDoItems" :key="item.id">
        <to-do-item :label="item.label" :done="item.done" :id="item.id" @checkbox-changed="updateDoneStatus(item.id)" @item-deleted="deleteToDo(item.id)"
